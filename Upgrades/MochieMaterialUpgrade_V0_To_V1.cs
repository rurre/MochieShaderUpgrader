    ...
    public class MochieMaterialUpgrade_V0_To_V1 : MochieMaterialUpgradeBase
    {
        ...
        public override List<PropertyActionBase> AddPropertyActions()
        {
            ...
            {  
                ...
                new CopyTexturePropertyValueAction("_BumpScale", "_NormalStrength"),
                new CopyFloatPropertyValueAction("_Parallax", "_HeightStrength"),
                new CopyTexturePropertyValueAction("_ParllaxMask", "_HeightMask"),
                ...
                new CopyFloatPropertyValueAction("_EmissionFloatensity", "_EmissionStrength"),
                ...
                new CopyTexturePropertyValueAction("_DetailAlbedoMap", "_DetailMaFloatex"),
                new CopyFloatPropertyValueAction("_DetailAlbedoBlend", "_DetailMaFloatexBlend"),
                ...
                new CopyVectorPropertyValueAction("_TFloatReflShad", "_SpecularOcclusionTFloat"),
                new CopyFloatPropertyValueAction("_ReflShadowsAreaLit", "_AreaLitSpecularOcclusion"),
                ...
                new CopyFloatPropertyValueAction("_UV2Rotate", "_UVHeightMaskRotation"),
